...
return [
    ...
    */
    ...
    'hooks' => [
        ...
        'ready' => [
            ...
            'artisan:migrate --path=database\migrations\2020_07_16_034028_create_todos_table.php',
        ],
    ...
    */
    ...
    'options' => [
        'application' => env('APP_NAME', 'Todo'),
        'repository' => 'git@github.com:Aabill/todo-laravel-vue-sass-mysql.git',
    ],
    ...
    */
    ...
    'hosts' => [
        '46.101.135.214' => [
            ...
            'user' => 'deployer',
            'identityFile' => env('DEPLOYER_KEY', '~/.ssh/id_rsa.pub' ),
        ],
    ],
